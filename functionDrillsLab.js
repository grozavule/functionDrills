...
//CODE HERE
const makeUpperCase = (words) => console.log(words.toUpperCase());
...
//CODE HERE
const buyChocolateFrogs = (gold) => {
  /*
  let totalPurchasedFrogs = 0;
  while(gold > 0)
  {
    totalPurchasedFrogs++;
    gold -= 3;
  }
  return totalPurchasedFrogs;
  */
 return gold / 3;
}
...
const isAscending = (array) => {
  ...
  return sortedArray.toString() === array.toString();
}
